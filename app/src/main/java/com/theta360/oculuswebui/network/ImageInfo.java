...
package com.theta360.oculuswebui.network;

/**
 * Information class of media file
 */
public class ImageInfo {
    public static final String FILE_FORMAT_CODE_EXIF_JPEG = "JPEG";
    public static final String FILE_FORMAT_CODE_EXIF_MPEG = "MPEG";
